...
public class Sales_EditItem extends javax.swing.JPanel {
    ...
    public Sales_EditItem(String itemCode, javax.swing.JPanel ChangePanel) {
        ...
        if(item != null){
            ...
            price.setText(String.format("%.2f", item.getUnitPrice()));
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(file))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (parts.length >= 8 && parts[0].trim().equalsIgnoreCase(itemCode.trim())) {
                        ...
                        String description = !parts[6].equals("") ? parts[6] : "";
                        Items.ReorderAlertStatus reorderStatus = Items.ReorderAlertStatus.fromString(parts[7]);
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        if(itemName.getText().trim().isEmpty()|| category.getSelectedIndex() == 0|| price.getText().trim().isEmpty()){
