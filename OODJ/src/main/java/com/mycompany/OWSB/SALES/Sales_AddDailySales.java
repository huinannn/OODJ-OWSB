...
import static com.mycompany.OWSB.SALES.DailySales.viewDSInFile;
 ...
 * @author xiaochingloh
 */
public final class Sales_AddDailySales extends javax.swing.JPanel {
    private javax.swing.JPanel ChangePanel;
    /**
     * Creates new form Sales_AddDailySales
     */
    public Sales_AddDailySales(javax.swing.JPanel ChangePanel) {
        initComponents();
        this.ChangePanel = ChangePanel;
        
        //Generate new salesID
        String newID = generateNextDSID();
        salesID.setText(newID);
    ...
    public String generateNextDSID(){
        List<DailySales> dsList = viewDSInFile();
        int maxID = 0;
        
        for(DailySales sales : dsList){
        ...
        int nextID = maxID +1;
        return String.format("DS%03d", nextID);
    }
    ...
    private void initComponents() {
        ...
        title.setText("NEW DAILY ITEM-WISE SALES");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(37, 37, 37)
                .addComponent(title)
                .addGap(131, 172, Short.MAX_VALUE))
